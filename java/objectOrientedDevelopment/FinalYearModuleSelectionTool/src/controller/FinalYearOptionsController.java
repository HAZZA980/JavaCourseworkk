...
import view.CreateSelectModulesPane;
...
public class FinalYearOptionsController {
	...
	/*public Course[] getCompSciCourses() {
		Course[] allCourses = buildModulesAndCourses();
		List<Course> compSciCourses = new ArrayList<>();

		for (Course course : allCourses) {
			if (course.getModule().equals("compSci")) {
				compSciCourses.add(course);
			}
		}

		return compSciCourses.toArray(new Course[0]);
	}*/
